...
(function (BingTTS) {
    var Client = (function () {
        ...
        Client.prototype.Synthesize = function (text, callback) {
            ...
            var apiKey = "COLOQUE A SUA CHAVE DE API DO BING SPEECH API AQUI";
            var post_data = "";
            ...
            this.makeHttpRequest(xhr, "", function (resultsText, resultsError) {
                ...
                var data = "<speak version='1.0' xml:lang='pt-br'><voice xml:lang='pt-BR' xml:gender='Male' name='Microsoft Server Speech Text to Speech Voice (pt-BR, Daniel, Apollo)'>" + text + "</voice></speak>";
