...
(function (BingTTS) {
    var Client = (function () {
        ...
        Client.prototype.Synthesize = function (text, callback) {
            ...
            var apiKey = "REEMPLAZAR CON LA KEY DE BING SPEECH API";
            var post_data = "";
            ...
            this.makeHttpRequest(xhr, "", function (resultsText, resultsError) {
                ...
                var data = "<speak version='1.0' xml:lang='es-es'><voice xml:lang='es-ES' xml:gender='Male' name='Microsoft Server Speech Text to Speech Voice (es-ES, Pablo, Apollo)'>" + text + "</voice></speak>";
